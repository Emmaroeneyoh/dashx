...
const { admincreateadminModel, adminaddroleModel, adminremoveroleModel } = require("../model/hr");
...
module.exports = {
    admincreateadminController , adminremoveroleController  ,  adminaddroleController 
}